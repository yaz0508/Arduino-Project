// ESP32 Laser Game - Web Controlled Edition (PLAYER 1)
...
// - This firmware is for PLAYER 1 VEST ONLY
...
const int PLAYER_NUMBER = 1;  // 1 for this vest

// ---- Pin assignments (PLAYER 1 ONLY) ----
// Sensors (ADC Pins)
const int PIN_SENSOR_1 = 32;  // Sensor 1
const int PIN_SENSOR_2 = 33;  // Sensor 2

// Buzzer
const int PIN_BUZZER = 25;  // Player 1 Buzzer
...
void sendScoreUpdate() {
  ...
  // Player 1 only sends its own score
  String body = "{\"gameId\":\"" + currentGameId + "\",\"player1Score\":" + String(player.score) + "}";
